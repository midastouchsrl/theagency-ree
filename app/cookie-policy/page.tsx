  ...
  return (
    <div className="pt-28 pb-20" style={{ backgroundColor: "var(--bg-alt)" }}>
      <article className="mx-auto max-w-3xl px-6 lg:px-12">
        ...
        <div className="space-y-8 text-sm leading-relaxed [&_h2]:mb-4 [&_h2]:mt-10 [&_h2]:text-lg [&_h2]:font-medium [&_h2]:tracking-wide [&_h3]:mb-2 [&_h3]:mt-6 [&_h3]:text-base [&_h3]:font-medium [&_ul]:ml-4 [&_ul]:list-disc [&_ul]:space-y-1" style={{ color: "var(--text-body)" }}>
